...
def main():
    # --- 1. Category ID 번역표 (원본 유지) ---
    CATEGORY_ID_MAP = [
        1899, 2482, 3350, 3482, 3543, 3742, 3831, 4377, 4542, 5093, 5885, 
        6191, 6562, 10220, 10223, 12080, 12246, 12419, 12777, 13394, 13899, 
    ...
    TEST_IMAGE_DIR = "/Users/moon/My Drive/00. MIT/07. Artifical Intelligence/250807_AI 강의/06. 팀과제 2/AI_Team2/test"  # <-- [!!경로 재확인!!]
    ...
    output_csv_path = os.path.join(latest_run_dir, 'submission_final_sorted.csv') # <-- (파일 이름 변경)
    ...
    with open(output_csv_path, 'w', newline='', encoding='utf-8') as f:
        ...
        for image_id, image_path in valid_image_list:
            ...
            results = model.predict(source=image_path, device='mps', conf=0.01, max_det=4)
