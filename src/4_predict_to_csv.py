...
# --- 1. Category ID 번역표 (총 73개로 수정됨) ---
    ...
    TEST_IMAGE_DIR = "/Users/moon/My Drive/00. MIT/07. Artifical Intelligence/250807_AI 강의/06. 팀과제/AI_Team2/preprocess_bf/test_images"  # <-- [!!쓰시는 2조분들 경로 확인!!]
    ...
    with open(output_csv_path, 'w', newline='', encoding='utf-8') as f:
        ...
        for image_id, image_path in valid_image_list:
            ...
            results = model.predict(source=image_path, device='mps', conf=0.25, max_det=4)
